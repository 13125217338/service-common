...
public class MvcConfig implements WebMvcConfigurer {
	...
	public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
		setConverter(converters, SpringUtil.getBean(RemoteConfigDto.class));
	}
	 ...
	 * @return 解析器
	 */
	public List<HttpMessageConverter<?>> setConverter(List<HttpMessageConverter<?>> converters, RemoteConfigDto remoteConfigDto) {
		converters.clear();
		/* FastJson设置解析 */
        ...
        if (remoteConfigDto != null) {
        	/* 验证是否返回空字符 */
        	if (remoteConfigDto.isWriteNull()) {
