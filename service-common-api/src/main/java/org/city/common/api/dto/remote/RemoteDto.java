...
public class RemoteDto {
	 ...
	 * @return 远程参数
	 */
	public static RemoteDto of(String requestId, String tranId, Integer speedLimit, Map<String, String> headers,
			String beanName, RemoteMethodDto remoteMethod, Object...args) {
		return new RemoteDto().setRequestId(requestId).setTranId(tranId).setSpeedLimit(speedLimit).setHeaders(headers)
