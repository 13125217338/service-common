...
public final class TaskService implements org.city.common.api.in.Task {
	...
	public TaskService(int core, int max, int maxTask, long maxTimeout) {
		TASK = new Task(core, max, maxTask, maxTimeout);
	}
	...
	@Override
	public org.city.common.api.in.Task cloneTask(int max, int maxTask) {
		return new TaskService(10, max, maxTask, 0);
	}
}
