...
public class ResponseException extends RuntimeException implements JSONParser {
	...
	public ResponseException(Response<?> response, String appName, RemoteIpPortDto remoteIpPort) {
		super(response.getMsg()); this.response = response; this.appName = appName; this.remoteIpPort = remoteIpPort;
	}
}
