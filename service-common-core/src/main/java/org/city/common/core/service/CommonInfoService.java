...
public class CommonInfoService implements CommonInfoApi {
	...
	/* 内存映射 */
	private final LinkedHashMap<String, Integer> MEMORY = getMemory();
	/* 时间映射 */
	private final LinkedHashMap<String, Integer> TIME = getTime();
	/* 获取内存映射 */
	...
	/* 转换展示 */
	private String parse(long dt, LinkedHashMap<String, Integer> datas) {
